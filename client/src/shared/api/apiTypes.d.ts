...
export interface components {
    schemas: {
        ...
        ApiEventsTicketsNonceVefiryCreateError: components["schemas"]["ApiEventsTicketsNonceVefiryCreateNonFieldErrorsErrorComponent"] | components["schemas"]["ApiEventsTicketsNonceVefiryCreateAddressErrorComponent"] | components["schemas"]["ApiEventsTicketsNonceVefiryCreateSignatureErrorComponent"] | components["schemas"]["ApiEventsTicketsNonceVefiryCreateMessageErrorComponent"] | components["schemas"]["ApiEventsTicketsNonceVefiryCreateNonceErrorComponent"];
        ApiEventsTicketsNonceVefiryCreateErrorResponse400: components["schemas"]["ApiEventsTicketsNonceVefiryCreateValidationError"] | components["schemas"]["ParseErrorResponse"];
