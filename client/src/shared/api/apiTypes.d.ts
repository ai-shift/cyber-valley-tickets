...
export interface paths {
    ...
    "/api/geodata/{id}/": {
         ...
         */
        get: operations["api_geodata_retrieve"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        ApiGeodataRetrieveErrorResponse400: components["schemas"]["ParseErrorResponse"];
    ...
    api_geodata_retrieve: {
        ...
        responses: {
            ...
            400: {
                ...
                content: {
                    "application/json": components["schemas"]["ApiGeodataRetrieveErrorResponse400"];
                };
            };
            401: {
                headers: {
