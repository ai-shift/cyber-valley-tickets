...
export const revenueSplitter = getContract({
  client,
  chain: cvlandChain,
  address: import.meta.env.PUBLIC_REVENUE_SPLITTER_ADDRESS,
  abi: [
    {
      inputs: [],
      name: "ADMIN_ROLE",
    ...
    },
    {
      ...
      name: "createDistributionProfile",
      outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
      stateMutability: "nonpayable",
      type: "function",
    },
    {
      ...
      name: "updateDistributionProfile",
      outputs: [],
      stateMutability: "nonpayable",
      type: "function",
    },
    ...
    },
    {
      ...
      name: "DistributionProfileCreated",
      type: "event",
    },
    {
      anonymous: false,
      ...
      name: "DistributionProfileUpdated",
      type: "event",
    },
  ],
});
