...
def split_kml_by_folder(input_kml_path, output_dir="output_kml_files"):
    ...
    if document_element is None:
        print("Warning: Could not find a <Document> tag. Checking styles under <kml> root.")
    ...
    for folder in folder_elements:
        ...
        for style_id in final_required_ids:
            if style_id in global_styles:
                ...
                print(f"  Warning: Style ID '{style_id}' referenced but not found globally. Skipping.")
        ...
        print(f"Successfully created: {output_filename} (Styles added: {styles_added_count})")
