...
async function main() {
  ...
  console.log("Event Request Price (formatted):", hre.ethers.formatUnits(eventRequestPrice, decimals));

  console.log("\n=== What frontend sends ===");
  console.log("Frontend getEventSubmitionPrice():", "100");
  console.log("Frontend formatted (assuming 18 decimals):", hre.ethers.formatUnits("100", decimals));

  console.log("\n=== Issue ===");
  if (eventRequestPrice.toString() !== "100") {
    console.log("❌ MISMATCH! Frontend sends 100 but contract expects", eventRequestPrice.toString());
